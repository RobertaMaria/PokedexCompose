...
fun HomeScreen(
    ...
    LaunchedEffect(pokemonLazyPagingItems.loadState.refresh) {
        if (pokemonLazyPagingItems.loadState.refresh is LoadState.NotLoading) {
    ...
    PokedexTheme {
        Surface {
            HomeScreen(
                ...
                availableTypes = listOf("Fire", "Water", "Grass", "Electric"),
                onTypeToggle = {},
                onClearFilters = {}
            )
        }
